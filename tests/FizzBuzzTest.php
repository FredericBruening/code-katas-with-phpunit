...
class FizzBuzzTest extends TestCase {
    ...
    /** @test */
    function it_prints_fizz_for_multiples_of_three()
    {
    ...
    /** @test */
    function it_prints_buzz_for_multiples_of_five()
    {
    ...
    /** @test */
    function it_prints_fizzbuzz_for_multiples_of_three_and_five()
    {
